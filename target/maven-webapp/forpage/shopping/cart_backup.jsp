...
<script src="../../js/cart_backup.js"></script>
		...
		<div id="gosecond" class="divclass">
			<div id="goforordercheck">
				<form>
					...
					<span>&nbsp;<a onclick="select_unselectAll(1)">全选<a/></span>&emsp;<a onclick="select_unselectAll(0)">全不选</a>&emsp;&emsp;&emsp;<span id="count">&nbsp;数量共计：  1  件</span>
					<br />
					<p>产品金额总计(不含运费)：<font id="totalPrice" style="color: #CC3333;font-size: 35px;">￥00.00</font></p>
				</form>
					<div id="buttongroup">
					<a href="index.html">&lt;&lt; 继续购物</a>&emsp;
					<a href="http://localhost:8080/homework_sp/forpage/GenerateOrderServlet?shipping_id=1">￥ 去结算 &gt;</a>
					</div>
